...
import com.navband.app.services.MapScreen
import com.navband.app.ui.theme.BLACK
                ...
                Column (modifier = Modifier.padding(30.dp), verticalArrangement = Arrangement.spacedBy(30.dp)) {
                    ...
                    ExposedDropdownMenuBox (
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {},
                            readOnly = true,
                            label = { Text("Selecione uma pulseira", color = MaterialTheme.colorScheme.inverseOnSurface) },
                            trailingIcon = {
